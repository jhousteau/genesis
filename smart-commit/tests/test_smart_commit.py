...
""")
        ...
        assert "pre-commit" in result.stdout.lower() or "pre-commit" in result.stderr.lower()
...
""")
    ...
    def test_script_permissions(self):
        ...
        assert file_stat.st_mode & 0o100, "smart-commit.sh should have execute permissions"
    ...
    def test_linting_tools_detection(self, temp_git_repo):
        ...
        black_available = subprocess.run(["which", "black"], capture_output=True).returncode == 0
