...
class MockFilesystem:
    ...
    def _create_structure_recursive(self, structure: Dict[str, Any], base: Path) -> None:
...
def create_genesis_project_structure(base_path: Path) -> MockFilesystem:
    ...
    structure = {
        ...
        'smart-commit': {
            ...
            'src': {
                'smart-commit.sh': '#!/usr/bin/env bash'
            },
            'tests': {
                'test_smart_commit.py': '"""Smart commit tests."""'
            }
        },
        'worktree-tools': {
            'README.md': '# Worktree Tools',
            'src': {
                'create-sparse-worktree.sh': '#!/usr/bin/env bash'
            },
            'tests': {
                'test_sparse_worktree.py': '"""Worktree tests."""'
            }
        },
        'shared-python': {
...
def create_test_project(name: str = "test-project", project_type: str = "python-api") -> MockFilesystem:
