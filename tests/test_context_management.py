...
class TestTraceContext:
    ...
    def test_create_child_span(self):
        ...
        parent_trace = TraceContext(
            trace_id="trace123", span_id="span456", baggage={"key": "value"}
        )
...
class TestRequestContext:
    ...
    def test_request_context_logger_context(self):
        ...
        trace = TraceContext(
            trace_id="trace123", span_id="span456", parent_span_id="parent789"
        )
        context = RequestContext(
            correlation_id="corr123",
            request_id="req456",
...
class TestContextManager:
    ...
    def test_create_context(self):
        ...
        context = manager.create_context(
            correlation_id="corr123", user_id="user456", metadata={"key": "value"}
        )
