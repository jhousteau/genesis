...
from core.context.manager import (  # Core classes; ID generation functions; Context access functions; Convenience functions; Header propagation functions; Global context manager
    ContextManager, CorrelationID, RequestContext, TraceContext, UserContext,
    add_baggage, add_metadata, extract_headers, generate_correlation_id,
    generate_span_id, generate_trace_id, get_baggage, get_context_manager,
    get_correlation_id, get_current_context, get_metadata, get_parent_span_id,
    get_request_id, get_session_id, get_span_id, get_trace_context,
    get_trace_id, get_user_context, get_user_id, propagate_headers,
    set_baggage, set_correlation_id, set_metadata, set_parent_span_id,
    set_request_id, set_session_id, set_span_id, set_trace_context,
    set_trace_id, set_user_context, set_user_id)
